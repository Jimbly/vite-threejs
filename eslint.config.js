...
function safeGlobals() {
  // All type-related browser globals (e.g. HTMLElement), but not ones that
  // would  alias common variables (e.g. status, alert)
  let ret = {};
  for (let key in globals.browser) {
    if (key[0] === key[0].toUpperCase()) {
      ret[key] = globals.browser[key];
    }
  }
  return ret;
}
      ...
      '@stylistic/indent': [
        ...
        2,
        {
          ...
          offsetTernaryExpressions: {
            // offsetTernaryExpressions: default should be: false,
            CallExpression: true,
          },
